...
Name "Burn to the Brim 4.1.1"
OutFile "../build/bttb-cpp-4.1.1-Win64-Installer.exe"
...
Section "Burn to the Brim (Required)" SecCore
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\BTTB" "DisplayVersion" "4.1.1"
